About micromagnetictests-feedstock
==================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/micromagnetictests-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9251&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/micromagnetictests-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `micromagnetictests` can be installed with `conda`:
...
```
mamba install micromagnetictests
```

It is possible to list all of the versions of `micromagnetictests` available on your platform with `conda`:
...
```
mamba search micromagnetictests --channel conda-forge
```
...
mamba repoquery search micromagnetictests --channel conda-forge

# List packages depending on `micromagnetictests`:
mamba repoquery whoneeds micromagnetictests --channel conda-forge

# List dependencies of `micromagnetictests`:
mamba repoquery depends micromagnetictests --channel conda-forge
```
